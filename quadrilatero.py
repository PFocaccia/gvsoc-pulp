...
class Soc(st.Component):
    ...
    def __init__(self, parent, name, parser):
        ...
        mem = memory.Memory(self, 'mem', size=0x1000000, latency=0)
        ...
        self.bind(host, 'mlsu_0', tohost, 'input')
        self.bind(host, 'mlsu_1', tohost, 'input')
        self.bind(host, 'mlsu_2', tohost, 'input')
        self.bind(host, 'mlsu_3', tohost, 'input')
